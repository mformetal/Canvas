...
import miles.canvas.event.EventBitmapChosen;
import miles.canvas.event.EventClearCanvas;
import miles.canvas.event.EventFilenameChosen;
import miles.canvas.fragment.FragmentBase;
import miles.canvas.fragment.FragmentBrushPicker;
import miles.canvas.fragment.FragmentColorPicker;
import miles.canvas.fragment.FragmentDrawer;
import miles.canvas.fragment.FragmentFilename;
import miles.canvas.fragment.FragmentText;
import miles.canvas.model.Sketch;
import miles.canvas.transition.TransitionHelper;
import miles.canvas.util.FileUtils;
import miles.canvas.util.Logg;
import miles.canvas.util.SafeSubscription;
import miles.canvas.util.ViewUtils;
import miles.canvas.view.ViewCanvasLayout;
import miles.canvas.view.ViewFab;
import miles.canvas.view.ViewRoundedFrameLayout;
