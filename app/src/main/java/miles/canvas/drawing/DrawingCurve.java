...
import miles.canvas.event.EventBrushChosen;
import miles.canvas.event.EventClearCanvas;
import miles.canvas.event.EventColorChosen;
import miles.canvas.event.EventTextChosen;
